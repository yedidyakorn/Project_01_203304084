...
public class TubeTest {
    ...
    public void getNormal() {
        ...
        assertEquals("ERROR- the function does not return a true normal vector", new Vector(0, 0, 1).normalize(), t1.getNormal(new Point3D(1, 5, 9)));

        // TC01: There is a simple single normal test for a point that is on the orthogonal to the tubes rays point..
